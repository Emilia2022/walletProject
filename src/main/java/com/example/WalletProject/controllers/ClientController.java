...
import com.example.WalletProject.exceptions.NotFoundClientException;
...
public class ClientController {
    ...
    public ClientInformationForMainPageDTO showClientById(@PathVariable("id") Long id) {
        ...
        if(clientInformationForMainPageDTO==null){
            throw new NotFoundClientException("Not client with id"+ id+"in database");
        }
